...
const ResetPassword = () => {
  return (
    <div className=" min-h-screen pt-20 ">
      <div className="sm:mx-auto   px-8 sm:w-2/4  bg-white ">
        <h3 className="text-center pt-16 font-bold text-4xl mb-5 ">
          Reset your password
        </h3>
        <p className="mb-6">
          Enter your email address below and we’ll send an email with a link to

...
import { ReactComponent as Company } from "./../../../assets/accounts/Company.svg";
import { ReactComponent as Player } from "./../../../assets/accounts/Player.svg";

const SignUpRecruitors = () => {
  return (
    <div className="flex h-full flex-row">
      <div className=" flex-row h-auto w-1/2 bg-recruitor bg-cover bg-no-repeat hidden sm:flex justify-between">
        <div className="bg-overlay">
          <div className=" ml-12">
            <Link to="/">
              <img src={Logo} className=" mb-72 mt-10" alt="" />
            </Link>
            <div className="text-white mb-10">
              <Player className="mb-4" />
              <h3 className="font-bold text-2xl">
                Get value, get verified accountants
              </h3>
              <p>
      ...
      <div className="sm:w-1/2 w-full mx-4 sm:mx-0 sm:ml-24">
        <div className="sm:mr-12">
          ...
          <h2 className="font-bold pt-24 text-4xl mb-6">Employer Sign up</h2>
        </div>
        <form action="" className="sm:mr-4 mb-28">
          ...
          <div className="sm:mr-40 mb-6">
            <p className="mb-2.5">Work Email</p>
          ...
          <div className="sm:mr-40 mb-6">
            <p className="mb-2.5">Company</p>

            {/* Company */}

            <label class="relative text-gray-400 focus-within:text-gray-600 block">
              <Company className="absolute w-6 h-6 top-2.5  left-4" />
          ...
          <div className="sm:mr-40 mb-6">
            <div className="flex flex-col  sm:flex-row ">
              <div className="sm:mr-6">
                <p className="mb-2.5">Company Location</p>
                {/* Location */}
                <label class="relative text-gray-400 focus-within:text-gray-600 block">
...
export default SignUpRecruitors;
